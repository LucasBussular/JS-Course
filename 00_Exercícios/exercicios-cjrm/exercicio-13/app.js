...
//    chaves colocadas antes do sinal de igual, com os nomes das constantes iguais às variáveis de dentro da função
...
const findDog = dogs.find( element => element.name = 'Zequinha')
...
const principal = document.querySelector('.main-title')
...
const nodeList = document.querySelectorAll('.secondary-title')
