...
/*
  ...
  - Exiba a mensagem abaixo no console, substituindo os ${cat.} pelas informações  
    corretas.
...
const dog = {
  ...
  age: 7,
  color: 'hazel',
  bestfriends: ['Belinha', 'Trator'],
  sound: function () {
    return 'auau'
  }
}

function addAge = (ageCat, ageDog) => ageCat + ageDog

const cao = dog.age;
const gato = cat.age;

const somatoria = addAge(gato, cao)

console.log(`A soma das idades de ${cat.name} e ${dog.name} é ${somatoria}.`)
